      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8">
        ...
        <div className="flex w-full lg:w-[55%] xl:w-[60%] flex-col justify-start gap-6 lg:pr-8">
          ...
          <h1 className="text-foreground font-playfair text-3xl sm:text-4xl lg:text-5xl xl:text-6xl lg:leading-[1.15] font-medium wrap-break-word">
            ...
            <span className="italic text-primary">dedication to flavor</span> is born.
          </h1>
          ...
          <p className="text-sm md:text-base text-foreground/70 leading-relaxed text-justify mb-2">
            ...
            hard work of hillside farmers. Each roast is a heartfelt tribute to 
            the long journey from ripe cherry to your cup.
          </p>

          {/* Banner Statistik (Kotak Krem di bawah teks) */}
        ...
        <div className="w-full lg:w-[45%] flex justify-center mt-12 lg:mt-0 relative">
          ...
          <div className="relative w-[90%] sm:w-[70%] lg:w-[420px] max-w-full z-10">
            ...
            {/* Kotak Melayang 2: Cupping Room */}
            <div className="absolute -bottom-8 -left-4 md:-left-16  bg-[#F6ECE7] p-4 rounded shadow-xl flex items-center gap-3 w-[280px] md:w-[320px] border border-white z-20">
              <BadgeCheck className="text-primary size-10" />
              <p className="text-xs text-primary leading-snug">
                <strong>Cupping Room Certified.</strong> Weekly SCA cupping standardization for every batch of green beans.
              </p>
            </div>
